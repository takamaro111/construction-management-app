...
import { Calendar, User, Plus, ChevronDown } from 'lucide-react'
...
type Project = {
  ...
  status: 'preparing' | 'in_progress' | 'completed' | 'suspended' | 'finished'
...
const columns: Column[] = [
  ...
  { id: 'completed', title: '契約中', status: 'completed', color: 'bg-blue-50 border-blue-200' },
  { id: 'suspended', title: 'リフォーム', status: 'suspended', color: 'bg-green-50 border-green-200' },
  { id: 'finished', title: '完了', status: 'finished', color: 'bg-gray-50 border-gray-200' }
]
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <button className="flex items-center gap-2 px-3 py-2 bg-gray-100 rounded-md text-sm font-medium">
              自社案件
  ...
  return (
    ...
    >
      ...
      <div className="space-y-3">
        ...
        <button className="w-full py-3 text-sm text-gray-500 hover:text-blue-500 border-2 border-dashed border-gray-200 hover:border-blue-300 rounded-lg transition-colors">
          + 案件を作成
        </button>
      </div>
    </div>
